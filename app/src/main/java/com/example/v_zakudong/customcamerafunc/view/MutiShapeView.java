...
/**
 * Created by v_zakudong on 2017/5/5.
 * 1.圆形图片，矩形圆角图片
 * 2.添加边界线颜色
 * 3.按下蒙板
 */

public class MutiShapeView extends View{
    ...
    *//**
     * 默认形状
     *//*
    public static final int SHAPE_RECT = 1;//矩形
    ...
    public MutiShapeView(Context context) {
        super(context);
        mContext = context;
        init();
    }

    public MutiShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MutiShapeView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray typedArray = context.obtainStyledAttributes(attrs,R.styleable.MutiShapeView,defStyleAttr,0);
        mContext = context;
        mBorderColor = typedArray.getColor(R.styleable.MutiShapeView_border_color,DEFAULT_BORDER_COLOR);
        mCoverColor = typedArray.getColor(R.styleable.MutiShapeView_cover_color,DEFAULT_COVER_COLOR);
        mBorderWidth = typedArray.getDimensionPixelSize(R.styleable.MutiShapeView_border_width,DEFAULT_BORDER_WIDTH);
        mShape = typedArray.getInteger(R.styleable.MutiShapeView_shape,SHAPE_CIRCLE);
        mRoundRadius = typedArray.getDimensionPixelSize(R.styleable.MutiShapeView_round_radius,DEFAULT_ROUND_RADIUS);
        typedArray.recycle();
        init();
    }
    ...
    public void setmCircleRadius(float circleRadius){
